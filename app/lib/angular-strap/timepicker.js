...
angular.module('mgcrea.ngStrap.timepicker', ['mgcrea.ngStrap.helpers.dateParser', 'mgcrea.ngStrap.tooltip'])
  ...
  .provider('$timepicker', function() {
    ...
    var defaults = this.defaults = {
      ...
      template: 'partials/AngularSnap/timepicker.tpl.html',
      trigger: 'focus',
      container: false,
      keyboard: true,
      html: false,
  ...
  .directive('bsTimepicker', function($window, $parse, $q, $locale, dateFilter, $timepicker, $dateParser, $timeout) {
    ...
    return {
      ...
      link: function postLink(scope, element, attr, controller) {
        ...
        angular.forEach(['placement', 'container', 'delay', 'trigger', 'keyboard', 'html', 'animation', 'template', 'autoclose', 'timeType', 'timeFormat', 'useNative', 'lang'], function(key) {
